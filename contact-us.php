                                ...
                                <div class="col-lg-6">
                                    ...
                                    <form method="POST" action="contact-form.php" class="log-form">
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            <select class="uk-input form-control" id="country" type="text"
                                                name="country" required="" aria-placeholder="country"
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            <select class="form-control" type="text" name="service_interested"
                                        ...
                                        <div
                                            ...
                                            <button class="slide-btn login-btn" type="submit" value="submit"
