                        ...
                        <div class="login-form">
                            ...
                            <div class="single-contact-box">
                                ...
                                <form method="POST" action="contact-form.php" class="log-form">
                                    ...
                                    <select class="uk-input form-control" id="country" type="text" name="country" required="" aria-placeholder="country" style="font-size: 14px; max-height: 150px; overflow-y: auto;">
                                    ...
                                    <select class="form-control" type="text" name="service_interested" required="" aria-placeholder="country"
