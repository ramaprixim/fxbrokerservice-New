        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="about-image">
                    <img src="img/content/digital - ForexSEO - image 1.png" alt="" class="ab-first-img">
                </div>
            </div>
            <!-- End column-->
            <!-- Start column-->
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="section-headline text-center">
                    <h3>Maximize Your Views</h3>
                    <p>FXBrokerService provides SEO services for Forex brokers to gain a competitive edge. Manage your
                        custom SEO campaign needs with digital marketing services like SEO, SMO.</p>
